class UserModel {
  ...
  */
  ...
  UserModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    this.phoneNo = parsedJson["phoneNo"];
    this.sid = parsedJson["_id"];
    this.friendList = parsedJson["friendList"];
    this.accessToken = parsedJson["accessToken"];
    this.refreshToken = parsedJson["refreshToken"];
  }
}
